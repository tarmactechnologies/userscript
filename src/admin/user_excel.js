...
function fillFirstPageForm() {
  ...
  if (automationState === '1') {
    ...
    if (currentRowIndex < excelData.length) {
      ...
      if (usernameField && password1Field && password2Field && companyField) {
        ...
        if (!companyFilled) console.error(`Erreur lors du remplissage de la position : ${userData.company}`);
        console.log(
...
export default function main() {
  detectPageAndFill();
  console.log("[TT Userscript] Users excel upload module loaded")
}
